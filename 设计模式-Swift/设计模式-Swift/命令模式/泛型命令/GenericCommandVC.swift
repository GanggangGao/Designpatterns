...
class GenericCommandVC: UIViewController {

    var Manager:GenericCommandManager?
    
    override func viewDidLoad() {
        super.viewDidLoad()

        // Do any additional setup after loading the view.
        self.Manager = GenericCommandManager.init(DanPinRealization())
    }
