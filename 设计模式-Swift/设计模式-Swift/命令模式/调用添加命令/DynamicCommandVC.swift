//
//  DynamicCommandVCViewController.swift
//  设计模式-Swift
//
...
class DynamicCommandVC: UIViewController {

    
    var Manager:DynamicCommandManager?
    
    override func viewDidLoad() {
        super.viewDidLoad()

        // Do any additional setup after loading the view.
        self.Manager = DynamicCommandManager.init(DanPinRealization())
    }
