...
- (NSString *)base64EncodedStringWithWrapWidth:(NSUInteger)wrapWidth
{
    ...
    //truncate data to match actual output length
    void *output = realloc((void *)outputBytes, outputLength);
    NSString *result = [[NSString alloc] initWithBytesNoCopy:output length:outputLength encoding:NSASCIIStringEncoding freeWhenDone:YES];
