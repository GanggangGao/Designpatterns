...
@implementation GGRSAEncryption


+ (id)shareInstance
{
    static GGRSAEncryption *_rsaHandler = nil;
...
- (NSData *)encryptDataWithData:(NSData *)enData Key:(NSString *)key{
    ...
    return [self encryptionData:enData WithRSAKeyType:KeyTypePublic];
    
}

- (NSData *)decryptDataWithData:(NSData *)deData key:(NSString *)key{
    return [self decryptData:deData WithRSAKeyType:KeyTypePublic];
}
...
- (NSString *)encryptDataWithString:(NSString *)enStr Key:(NSString *)key{
    ...
    return [self encryptDictionary:[self dictionaryWithJsonString:enStr] WithRSAKeyType:KeyTypePublic];
...
- (NSString *)decryptDataWithString:(NSString *)deStr key:(NSString *)key{
    ...
    NSDictionary *dict = [self decryptString:deStr WithRSAKeyType:KeyTypePublic];
    return  [self conversionDictionary:dict];
